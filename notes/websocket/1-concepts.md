...
> [!NOTE]
> WebSocket is not HTTP. While it can operate over HTTP ports 80 and 443 and is designed to work with HTTP proxies, they are fundamentally different protocols
